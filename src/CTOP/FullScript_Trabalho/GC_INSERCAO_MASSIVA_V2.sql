...
INSERT ALL
    ...
    INTO ControladordeVoo VALUES (4, 'Leonardo Da Vinci', 'Setor D', 'Noturno', 4, 2, '2Z', 'PTB', 42345, 97890)
SELECT 1 FROM DUAL;
...
INSERT ALL
    ...
    INTO Alocacao VALUES (2, 2, TO_TIMESTAMP('2024-11-22 13:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-11-22 15:30:00', 'YYYY-MM-DD HH24:MI:SS'), 2, 2, 'G3', 'GLO')
SELECT 1 FROM DUAL;
